function showLinkTooltip() {
    ...
    linkTooltip.setAttribute('style', `left: 0px; top: 0px;max-width: ${configs.circleRadius * 2}px;z-index: 99999; font-size: 13.5px;opacity: 0.0; align-items: center;display:inline-block !important; position: absolute !important;background: ${typeOfMenu == 'linkMenu' ? configs.linkMenu.color : typeOfMenu == 'imageMenu' ? configs.imageMenu.color : configs.regularMenu.color}; border-radius: 9px;color: white; text-align: center; padding: 6px; pointer-events: none;`);

    let label = document.createElement('span');
    // label.innerHTML = typeOfMenu == 'linkMenu' ? chrome.i18n.getMessage('Link') : chrome.i18n.getMessage('Image');
