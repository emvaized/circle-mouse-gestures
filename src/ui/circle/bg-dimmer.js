function showBackgroundDimmer() {
    ...
    backgroundDimmer.setAttribute('style', `overflow: hidden; z-index: 9999; width:${document.documentElement.clientWidth}px; height: ${document.documentElement.scrollHeight}px;  opacity: 0.0; transition: opacity ${configs.animationDuration}ms ease-in-out; position:absolute; background: black !important; top: 0px; left: 0px;`);
